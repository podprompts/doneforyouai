...
const projects = [
  ...
  { id: 10, name: 'HireAIReceptionist.com',   url: 'hireaireceptionist.com',   href: 'https://hireaireceptionist.com',   tag: 'Business Automation',  year: '2025', description: 'AI receptionist that answers calls, qualifies leads, books appointments, and delivers 24/7 customer support — for less than the cost of one shift.',  stack: ['Next.js', 'Supabase', 'Twilio', 'ElevenLabs', 'Stripe'],             screenshot: '/screenshots/hireaireceptionist.png',   light: false },
]
