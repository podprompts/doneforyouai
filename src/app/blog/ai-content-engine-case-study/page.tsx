...
export const metadata: Metadata = {
  ...
  description: 'From zero to a fully automated content pipeline Ã¢â‚¬â€ blog posts, emails, social, and ads Ã¢â‚¬â€ all running without a full-time writer. Here\'s exactly how we did it.',
      ...
      <article style={{ maxWidth: '740px', margin: '0 auto', padding: 'clamp(4rem,10vw,6rem) clamp(1.5rem,5vw,2.5rem) 6rem' }}>
        ...
        <div style={{ marginBottom: '3rem' }}>
          ...
          <p style={{ fontSize: '18px', fontWeight: 300, color: 'rgba(247,245,240,0.55)', lineHeight: 1.7 }}>
            From zero to a fully automated content pipeline Ã¢â‚¬â€ blog posts, emails, social, and ads Ã¢â‚¬â€ all running without a full-time writer. Here's exactly how we did it.
          </p>
        </div>
        ...
        <div className="stat-row">
          {[
            ...
            { value: '40Ãƒâ€”', label: 'increase in monthly content output' },
        ...
        <p style={prose}>The founder had been running their Shopify store for three years with strong word-of-mouth but almost no content marketing. They knew they were leaving organic search traffic on the table Ã¢â‚¬â€ competitors with lower-quality products were outranking them because they published consistently.</p>
        ...
        <p style={prose}>They came to us asking: "Can AI handle this?" The answer was yes Ã¢â‚¬â€ but not by just plugging in ChatGPT and hoping for the best.</p>

        <h2 style={h2}>Week one: architecture and training</h2>

        <h3 style={h3}>Day 1Ã¢â‚¬â€œ2: Brand voice extraction</h3>
        <p style={prose}>Before any AI touches content, it needs to understand how the brand sounds. We pulled every piece of existing content Ã¢â‚¬â€ product descriptions, email campaigns, customer service responses, the founder's personal emails. We ran a brand voice analysis and documented: tone (warm but direct), vocabulary (avoided jargon, preferred concrete specifics), sentence structure (short paragraphs, active voice), and what the brand explicitly doesn't sound like.</p>
        ...
        <h3 style={h3}>Day 3Ã¢â‚¬â€œ4: Content strategy and topic framework</h3>
        ...
        <p style={prose}>For each pillar, we identified the 20 highest-value search topics using keyword research Ã¢â‚¬â€ terms with real monthly volume and low-to-medium competition that the brand could realistically rank for in 90Ã¢â‚¬â€œ180 days.</p>

        <h3 style={h3}>Day 5Ã¢â‚¬â€œ7: Building the pipeline</h3>
        ...
        <ul style={{ ...prose, paddingLeft: '1.5rem' }}>
          ...
          <li style={{ marginBottom: '0.5rem' }}><strong style={{ color: '#f7f5f0' }}>Human review:</strong> The founder or a team member reviews for accuracy and brand fit. This takes 10Ã¢â‚¬â€œ15 minutes per piece, not 2Ã¢â‚¬â€œ3 hours.</li>
          <li style={{ marginBottom: '0.5rem' }}><strong style={{ color: '#f7f5f0' }}>Repurposing:</strong> The approved blog post feeds an email newsletter version, three social captions, and one ad headline set Ã¢â‚¬â€ automatically.</li>
        </ul>

        <h2 style={h2}>Week two: integration and launch</h2>

        <h3 style={h3}>Day 8Ã¢â‚¬â€œ10: CMS and email integration</h3>
        ...
        <h3 style={h3}>Day 11Ã¢â‚¬â€œ12: Social scheduling</h3>
        <p style={prose}>Social captions generated from each piece get routed to a Buffer queue. The team reviews the weekly batch on Monday morning Ã¢â‚¬â€ takes about 20 minutes Ã¢â‚¬â€ and approves for the week. Instagram, Pinterest, and Facebook covered from a single review session.</p>

        <h3 style={h3}>Day 13Ã¢â‚¬â€œ14: Testing, training, handoff</h3>
        ...
        <p style={prose}>Ten to fifteen minutes of human review per piece is not a burden. It's insurance Ã¢â‚¬â€ and it's what separates "AI-assisted content" from "AI slop."</p>
        ...
        <div style={{ background: '#1a1a18', border: '1px solid rgba(255,255,255,0.07)', padding: '2.5rem', marginTop: '3rem', textAlign: 'center' }}>
          ...
          <p style={{ ...prose, maxWidth: '42ch', margin: '0 auto 1.75rem', color: 'rgba(247,245,240,0.4)' }}>No long onboarding. No confusing tech. Just a system that runs Ã¢â‚¬â€ built in weeks, not months.</p>
