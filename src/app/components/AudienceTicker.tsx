...
// Only 2 copies needed â€” we animate exactly -50% for a perfect seamless loop
    ...
    <div style={{
      ...
      <style>{`
        ...
        .at-track {
          ...
          animation: at-scroll 22s linear infinite;
        ...
        @media (max-width: 768px) {
          .at-track {
            animation: at-scroll 3s linear infinite;
          }
        }
