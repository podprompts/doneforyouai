...
export default function AudienceTicker() {
  return (
    <div style={{ background: '#0f0f0e', borderBottom: '1px solid rgba(255,255,255,0.08)', borderTop: '1px solid rgba(255,255,255,0.08)', padding: '1.1rem 0', overflow: 'hidden', position: 'relative', margin: '2rem 0' }}>
      ...
      <style>{`        .at-outer { overflow: hidden; width: 100%; }
        ...
        .at-track:hover { animation-play-state: paused; }`}</style>
    </div>
  )
}
