      ...
      <div style={{
        ...
        <div>
          ...
          <p style={{
            ...
            color: 'var(--muted-light)', lineHeight: 1.75, marginBottom: '2.5rem',
          }}>
          ...
          {status === 'success' ? (
            <div style={{
              ...
              <div style={{
                ...
                color: 'var(--coral)', fontSize: '1.2rem',
              }}>✓</div>
              <h3 style={{
              ...
              <p style={{
                ...
                color: 'var(--muted-light)', lineHeight: 1.7,
              }}>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: '1.5rem' }}>
              ...
              <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '1.5rem' }}>
                <div>
                  <label style={{
                    ...
                    color: 'var(--muted-light)', display: 'block', marginBottom: '0.25rem',
                  }}>Name *</label>
                  <input
                    type="text"
                    value={form.name}
              ...
              {status === 'error' && (
                <p style={{
                  ...
                  color: '#e53e3e', letterSpacing: '0.06em',
                }}>
                  Something went wrong. Email us directly at hello@doneforyouai.com
                </p>
              )}
            </div>
          )}
