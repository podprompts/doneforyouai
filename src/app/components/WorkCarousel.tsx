...
const projects = [
  ...
  { id: 10, name: 'Hire AI Receptionist',    url: 'hireaireceptionist.com',   href: 'https://hireaireceptionist.com',   tag: 'Business Automation',  description: 'AI receptionist that answers calls, qualifies leads, books appointments, and delivers 24/7 support — for less than the cost of one shift.',  screenshot: '/screenshots/hireaireceptionist.png',   light: false },
]
